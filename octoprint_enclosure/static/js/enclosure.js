$(function () {
  function EnclosureViewModel(parameters) {
    ...
    self.addRpiOutput = function () {
      self.global_settings.settings.plugins.enclosure.rpi_outputs.push({
        label: ko.observable("Ouput " +
        ...
        outputType: ko.observable('regular'), frequency: 50, dutycycle: 0, color: "rgb(255,0,0)", 
        neopixelCount: 0, neopixelBrightness: 255, microAddress: 0
      });
    };
